			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="row">
					<form method="POST"
						...
						<div class="mb-3 row">
							<label for="apePaterno" class="col-sm-3 col-form-label">Descripción:</label>
							<div class="col-sm-9">
								<input type="text" name="descripcion" class="form-control"/>
							</div>
						</div>
						<div class="mb-3 row">
							<label for="apeMaterno" class="col-sm-3 col-form-label">Precio:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="edad" class="col-sm-3 col-form-label">Imagen:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="edad" class="col-sm-3 col-form-label">Número
								de Existencias:</label>
							<div class="col-sm-9">
								<input type="number" name="numExistencias" min="0"
									class="form-control">
							</div>
						</div>
						<div class="mb-3 row">
							<label for="telefono" class="col-sm-3 col-form-label">Código
								de Barras:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="edad" class="col-sm-3 col-form-label">Porcentaje
								de IVA:</label>
							<div class="col-sm-9">
								<div class="input-group mb-3">
									<input type="number" step="0.1" min="0" name="ivaPorcentaje"
										class="form-control">
									<div class="input-group-append">
						...
						<div class="row">
							<div class="col-6">
								<div
									class="text-center d-flex justify-content-center text-lg-start mt-4 pt-2">
